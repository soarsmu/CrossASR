    ...
    while x < 3 : 
        ...
        while (not q.empty() and current_bug < needed_bugs_max) :
            ...
            if (is_predicted_bug) :
                ...
                if NON_BUG_LABEL not in case.values() :
                    print("Can't determine bug")
                elif np.sum(list(case.values())) == 0 :
                    ...
                    r = {}
                    r["time_execution"] = time_execution
                    r["number_of_data"] = i
        ...
        file = open("result/estimated/with_classifier_" + str(needed_bugs_max) + "_" +
        ...
        file = open("result/estimated/without_classifier_" + str(needed_bugs_max) + "_" +
                    str(datetime.now()) + ".txt", "w+")
        i = 0
        for k in result.keys():
            i += 1
